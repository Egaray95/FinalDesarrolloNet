...
namespace ClinicaP2.Models
{
    ...
    public partial class bdclinicEntities : DbContext
    {
        ...
        public virtual int SP_ADIRSERVA(Nullable<System.DateTime> fECHA, string cODPAC, string cODMED, Nullable<double> pRECIO, string cODPAY, string cODESTADO, string cODUSER)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_ADIRSERVA", fECHAParameter, cODPACParameter, cODMEDParameter, pRECIOParameter, cODPAYParameter, cODESTADOParameter, cODUSERParameter);
        }
